нужно написать программу для авиакомпании, которая будет распределять
пассажиров по местам в самолёте. Чтобы не усложнять, будем считать,
что места идут последовательно: 1, 2, 3, ..., 50, 51, 52 и так далее. 
...
- После назначения места пассажиру нужно не забыть увеличивать переменную-счётчик на 1: seat += 1;.
